      ...
      <div class="row row-offcanvas row-offcanvas-right">
       ...
       <p<?php if($pageid_n==36) ?>><a class="btn btn-default" href="Newsshow.php?page_n=36"  role="button">View details &raquo;</a></p>
            ...
            <div class="col-xs-6 col-lg-4">
                  ...
                  <h2><?php echo $sports_page['header10']; ?></h2>
              <p> <?php echo $sports_page['body10']; ?></p>
             <p<?php if($pageid_n==37) ?>><a class="btn btn-default" href="Newsshow.php?page_n=37"  role="button">View details &raquo;</a></p>
            </div><!--/.col-xs-6.col-lg-4-->
          </div><!--/row-->
